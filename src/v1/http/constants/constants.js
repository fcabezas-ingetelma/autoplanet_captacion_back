...
export const SMS_MESSAGE_CANAL_18 = 'Regístrate en Autoplanet de Av. Pajaritos 3005, compra cualquier producto y participa por un Ipad 32GB 10.2" Space Grey Wi-Fi. Pincha el Link: {$LINK}';
